...
import com.schnettler.outline.Constants.ENABLE_KNOWN_THIRD_PARTY_THEME_MANAGERS
import com.schnettler.outline.Constants.ENFORCE_MINIMUM_SUBSTRATUM_VERSION
import com.schnettler.outline.Constants.MINIMUM_SUBSTRATUM_VERSION
import com.schnettler.outline.Constants.OTHER_THEME_SYSTEMS
import com.schnettler.outline.Constants.SUBSTRATUM_FILTER_CHECK
import com.schnettler.outline.Constants.THEME_READY_GOOGLE_APPS
import com.schnettler.outline.Constants.THEME_READY_PACKAGES
import com.schnettler.outline.ThemeFunctions.SUBSTRATUM_PACKAGE_NAME
import com.schnettler.outline.ThemeFunctions.checkNetworkConnection
import com.schnettler.outline.ThemeFunctions.checkSubstratumIntegrity
import com.schnettler.outline.ThemeFunctions.getSelfSignature
import com.schnettler.outline.ThemeFunctions.getSelfVerifiedIntentResponse
import com.schnettler.outline.ThemeFunctions.getSelfVerifiedPirateTools
import com.schnettler.outline.ThemeFunctions.getSelfVerifiedThemeEngines
import com.schnettler.outline.ThemeFunctions.getSubstratumFromPlayStore
import com.schnettler.outline.ThemeFunctions.getSubstratumUpdatedResponse
import com.schnettler.outline.ThemeFunctions.hasOtherThemeSystem
import com.schnettler.outline.ThemeFunctions.isCallingPackageAllowed
import com.schnettler.outline.ThemeFunctions.isPackageInstalled
import java.io.File
import java.util.*
...
class SubstratumLauncher : Activity() {
    ...
    init {
        System.loadLibrary("LoadingProcessLight")
    }
